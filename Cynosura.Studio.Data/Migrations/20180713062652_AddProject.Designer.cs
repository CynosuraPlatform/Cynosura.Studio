...
namespace Cynosura.Studio.Data.Migrations
{
    ...
    [Migration("20180713062652_AddProject")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cynosura.Studio.Core.Entities.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Cynosura.Studio.Core.Entities.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Cynosura.Studio.Core.Entities.User")
                        .WithMany()
