...
@Component({
    ...
    providers: [
        { provide: MatFormFieldControl, useExisting: TemplateSelectComponent }
    ]
})

export class TemplateSelectComponent implements OnInit, ControlValueAccessor,
    ...
    focused = false;
    controlType = 'app-template-select';
    id = `template-select-${TemplateSelectComponent.nextId++}`;
    describedBy = '';
