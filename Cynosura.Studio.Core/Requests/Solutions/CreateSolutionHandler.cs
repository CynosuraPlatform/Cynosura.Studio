...
{
    public class CreateSolutionHandler : IRequestHandler<CreateSolution, int>
    {
        ...
        public async Task<int> Handle(CreateSolution request, CancellationToken cancellationToken)
        {
